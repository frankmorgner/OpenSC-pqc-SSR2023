...
const char *gengetopt_args_info_help[] = {
  ...
  "      --create-cvc              Create a post quantum card verifiable\n                                  certificate",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->create_cvc_given = 0 ;
  args_info->pqc_mode_counter = 0 ;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->create_cvc_help = gengetopt_args_info_help[31] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->create_cvc_given)
    write_into_file(outfile, "create-cvc", 0, 0 );
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Create a post quantum card verifiable certificate.  */
          else if (strcmp (long_options[option_index].name, "create-cvc") == 0)
          {
            args_info->pqc_mode_counter += 1;
          
          
            if (update_arg( 0 , 
                 0 , &(args_info->create_cvc_given),
                &(local_args_info.create_cvc_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "create-cvc", '-',
                additional_error))
              goto failure;
  ...
  if (args_info->pqc_mode_counter && args_info->pxs_mode_counter) {
    int pqc_given[] = {args_info->create_cvc_given,  -1};
    const char *pqc_desc[] = {"--create-cvc",  0};
    ...
    error_occurred += check_modes(pqc_given, pqc_desc, pxs_given, pxs_desc);
  }
  if (args_info->pqc_mode_counter && args_info->soc_mode_counter) {
    int pqc_given[] = {args_info->create_cvc_given,  -1};
    const char *pqc_desc[] = {"--create-cvc",  0};
    ...
    error_occurred += check_modes(pqc_given, pqc_desc, soc_given, soc_desc);
  }
