...
struct gengetopt_args_info
{
  ...
  const char *create_cvc_help; /**< @brief Create a post quantum card verifiable certificate help description.  */
  ...
  unsigned int create_cvc_given ;	/**< @brief Whether create-cvc was given.  */

  int pqc_mode_counter; /**< @brief Counter for mode pqc */
